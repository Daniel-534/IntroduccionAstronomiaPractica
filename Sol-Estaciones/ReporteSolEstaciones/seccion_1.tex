...
\begin{table}[H]
  \centering
  \caption[Eventos solares principales en 2026 y declinación solar]{Fechas aproximadas de los principales eventos solares en 2026 y la
...
\begin{table}[H]
  \centering
  \caption[Coordenadas geográficas de las cinco ciudades de estudio]{Coordenadas geográficas de las cinco ciudades de estudio
...
Las funciones \texttt{Observer.sun\_rise\_time()} y \texttt{Observer.sun\_set\_time()}
calculan, para cada fecha, el amanecer previo y el atardecer siguiente al mediodía local.
...
\begin{table}[H]
  \centering
  \caption[Horas de salida y puesta del Sol en las cinco ciudades durante 2026]{Horas de salida y puesta del Sol (salida -- puesta, hora local) en las cinco
...
\begin{table}[H]
  \centering
  \caption[Duración del día solar en las cinco ciudades durante 2026]{Duración del día solar (horas y minutos de luz) en las cinco ciudades durante
           2026.
           Fuente: \texttt{astroplan} \citep{Morris2018}.}
  \label{tab:duracion}
  {\scriptsize
