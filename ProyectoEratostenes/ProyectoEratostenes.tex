...
% ── Bibliografía (autor-año, estilo APA) ───────────────────────────────────
...
% ──────────────────────────────────────────────────────────────────────────
\title{\textbf{Midiendo el planeta experimentalmente mediante el método de Eratóstenes en el equinoccio de primavera del 2026}}
\author{
  Daniel Soto Villada \and
  Jean Lucca Buritica Cuervo \and
  Camilo Higuita\\[0.5em]
  \small Universidad de Antioquia --- Introducción a la Astronomía Práctica
}
\date{Marzo de 2026}
% ──────────────────────────────────────────────────────────────────────────
...
\begin{abstract}
% ── Resumen (español) ─────────────────────────────────────────────────────
Se replica el experimento de Eratóstenes para medir el radio terrestre
...
The experiment of Eratosthenes is reproduced to measure Earth's radius
...
matemático (Figura~\ref{fig:foto_plomada}).
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.45\textwidth]{img/MedicionLongitudDeSombra.jpeg}
  \caption{Captura de datos experimentales: marcando el extremo de la
           sombra sobre el plano horizontal con un lápiz.}
  \label{fig:foto_sombra}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.45\textwidth]{img/MedicionVerticalidadConPlomada.jpeg}
  \caption{Verificación de la verticalidad del gnomon mediante el uso
           de una plomada, garantizando que la vara esté perpendicular
           al horizonte matemático.}
  \label{fig:foto_plomada}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{img/fig1_sombra_vs_tiempo.png}
  \caption{Longitud de sombra del gnomon en función del tiempo para el
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.65\textwidth]{img/fig2_diagrama_gnomon.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.65\textwidth]{img/fig4_latitud_calculada.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.90\textwidth]{img/fig3_comparacion_radio.png}
  \caption{Comparación del radio terrestre calculado con el valor de
...
\begin{enumerate}
  \item \textbf{Incertidumbre en la longitud de la sombra} ($\delta s$):
        fuente dominante ($\sim 70$--$80\,\%$ del error total), causada
  ...
  \item \textbf{Incertidumbre en la distancia meridional} ($\delta d$):
        segunda contribución ($\sim 15$--$25\,\%$).
...
$R \approx 6\,267$~km) tiene un error de $\sim 1{,}6\,\%$ respecto al
valor moderno \citep{Britannica2024}.
Nuestra medición principal (error $\approx 0{,}96\,\%$) logra mayor
...
\begin{enumerate}
  ...
  \item La fuente de error dominante es la incertidumbre en la
        medición de la longitud de la sombra ($\sim 70$--$80\,\%$ del
        error total).
